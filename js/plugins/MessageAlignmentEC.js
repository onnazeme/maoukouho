//
//  メッセージアライメント制御文字 ver1.03
//
// author yana
//

var Imported = Imported || {};
Imported['MessageAlignmentEC'] = 1.03;
/*:
 * @plugindesc ver1.03/メッセージのアライメントを変更する制御文字を追加します。
 * @author Yana
 *
 * @param ExtendEC
...
(function() {
    ...
    Window_Base.prototype.textWidthEx = function (text) {
        var result = 0;
        text = text.replace(/\x1bC\[\d+\]/i, '');
        text = text.replace(/\x1bI\[\d+\]/i, function () {
